...
<html>
  ...
  <body>
        ...
        <ul class="skills">
          ...
          <li id="illustrator" class="skill">
            ...
            <ul class="skill-list">
              ...
              <li>Repeatable Background Patterns</li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <section id="portfolio">
        ...
        <div id="projects">
          <a id="jt" class="project" href="http://jt.ms">
          ...
          <a id="cv" class="project" href="http://www.cambodiavietnam2010.com" data-text="Un résumé super sympa.">
          ...
          <a id="wp" class="project" href="http://wordpress.bbxdesign.com">
          ...
          <a id="em" class="project" href="http://editions-magellan.com">
          ...
          <a id="at" class="project" href="http://australietrip.fr">
          ...
          <a id="tt" class="project" href="http://task-this.bbxdesign.com">
          ...
          <a id="jg" class="project" href="http://jgthms.com">
          ...
          <a id="yk" class="project" href="http://yeek.fr">
          ...
          <a id="rtt" class="project" href="http://reachthethrone.com">
          ...
          <a id="css" class="project" href="http://css.steaw.com">
        ...
        <div id="stories-reel">
          <div class="story current" data-related="0">
            <div class="story-content">
              <time style="background-color: rgb(109, 137, 172); border-bottom-color: rgb(50, 89, 137);">1</time>
          ...
          <div class="story" data-related="2">
            <div class="story-content">
              <time style="background-color: rgb(205, 205, 0); border-bottom-color: rgb(138, 138, 0);">2</time>
          ...
          <div class="story" data-related="3">
            <div class="story-content">
              <time style="background-color: rgb(78, 78, 78); border-bottom-color: rgb(31, 31, 31);">3</time>
          ...
          <div class="story" data-related="3">
            <div class="story-content">
              <time style="background-color: rgb(78, 78, 78); border-bottom-color: rgb(31, 31, 31);">4</time>
          ...
          <div class="story" data-related="4">
            <div class="story-content">
              <time style="background-color: rgb(0, 153, 204); border-bottom-color: rgb(5, 99, 130);">5</time>
          ...
          <div class="story" data-related="5">
            <div class="story-content">
              <time style="background-color: rgb(182, 0, 0); border-bottom-color: rgb(133, 6, 6);">6</time>
          ...
          <div class="story" data-related="6">
            <div class="story-content">
              <time style="background-color: rgb(9, 64, 98); border-bottom-color: rgb(2, 28, 44);">7</time><h5>St Lazare et horizons</h5>
          ...
          <div class="story" data-related="6">
            <div class="story-content">
              <time style="background-color: rgb(9, 64, 98); border-bottom-color: rgb(2, 28, 44);">8</time>
